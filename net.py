...
print(sess.run(sum_fin,feed_dict={x:np.ones(shape=[10,10,1], dtype = float)}))
# print(sess.run(two))
...
output_graph_def = graph_util.convert_variables_to_constants(sess, graph_def,output_node_names=["sum_fin_op"])
